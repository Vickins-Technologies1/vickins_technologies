          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] gap-10 lg:gap-16">
              ...
              >
                ...
                <p className="text-sm text-[var(--foreground)]/75 mt-3 max-w-xl">
                  Strategy, design, and engineering that help teams launch faster, scale reliably, and stand apart.
                </p>

                <div className="mt-6 inline-flex items-center gap-3 rounded-full border border-white/50 bg-white/70 px-4 py-2 text-[10px] uppercase tracking-[0.3em] text-[var(--foreground)]/70">
                ...
                <div className="mt-8 flex flex-wrap gap-3">
                  <a
                    href="#contact"
                    className="inline-flex items-center gap-2 rounded-full bg-[var(--button-bg)] px-5 py-2.5 text-xs uppercase tracking-[0.24em] font-semibold text-white shadow-lg"
                  >
                    Book a Call
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-2 rounded-full border border-white/50 bg-white/70 px-5 py-2.5 text-xs uppercase tracking-[0.24em] font-semibold text-[var(--foreground)]/70"
                  >
            ...
            <motion.div
              className="mt-10 pt-6 border-t border-white/30 flex flex-col md:flex-row md:items-center md:justify-between gap-3"
              initial={{ opacity: 0 }}
