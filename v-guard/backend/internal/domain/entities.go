...
type User struct {
	...
	// Credits is retained as the internal wallet unit for backward compatibility.
	Credits          float64   `bson:"credits" json:"-"`
	TotalUsedBytes   int64     `bson:"totalUsedBytes" json:"totalUsedBytes"`
	TrafficBalanceGB float64   `bson:"-" json:"trafficBalanceGB"`
	TrafficUsedGB    float64   `bson:"-" json:"trafficUsedGB"`
...
type ProxyPlan struct {
	...
	Credits         float64            `bson:"credits" json:"-"`
	TrafficGB       float64            `bson:"trafficGB,omitempty" json:"trafficGB"`
...
type PaymentIntent struct {
	...
	Credits            float64            `bson:"credits" json:"-"`
	TrafficGB          float64            `bson:"trafficGB,omitempty" json:"trafficGB"`
	PricePerGBUSDCents int64              `bson:"pricePerGBUSDCents,omitempty" json:"pricePerGBUSDCents"`
...
type UsageSnapshot struct {
	...
	CreditsUsed   float64            `bson:"creditsUsed" json:"-"`
	TrafficUsedGB float64            `bson:"-" json:"trafficUsedGB"`
