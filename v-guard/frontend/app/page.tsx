...
const features = [
  ...
  { icon: BanknotesIcon, eyebrow: "Credits", title: "Credit balance", copy: "Track available credits and use plans to add more through the billing flow." },
...
const process = [
  ...
  ["03", "Choose a plan", "Review an active proxy package with its currency, credits, and bandwidth."],
  ["04", "Complete checkout", "Continue to Flutterwave, then return to your credited account after confirmation."],
] as const;
...
function DashboardPreview() {
  return <div className="preview-shell"><div className="preview-topbar"><div className="preview-brand"><span className="preview-dot" /> V-GUARD</div><span className="preview-avatar">A</span></div><div className="preview-body"><div className="preview-sidebar"><span className="preview-sidebar-active">Overview</span><span>Usage</span><span>Billing</span><span>Settings</span></div><div className="preview-content"><div className="preview-heading"><div><small>WELCOME BACK</small><strong>Control center</strong></div><span className="preview-status">● Active</span></div><div className="preview-stat-grid"><div><small>Balance</small><strong>credits</strong></div><div><small>Plans</small><strong>available</strong></div><div><small>Usage</small><strong>tracked</strong></div></div><div className="preview-lower"><div className="preview-panel"><small>PROXY CREDENTIALS</small><div className="preview-line"><span>HTTP</span><b>credential ready</b></div><div className="preview-line"><span>SOCKS5</span><b>credential ready</b></div></div><div className="preview-panel"><small>ACCOUNT STATE</small><div className="preview-bars"><i /><i /><i /><i /><i /></div><span className="preview-caption">Recent usage snapshots</span></div></div></div></div></div>;
}

export default function HomePage() {
  return <main>
    <header className="site-header"><div className="site-nav"><Link href="/" className="brand" aria-label="V-Guard home"><Image src="/v-guard-logo.png" alt="V-Guard logo" width={44} height={44} priority /><span>V-GUARD <small>SYSTEM</small></span></Link><nav className="desktop-nav" aria-label="Primary navigation"><a href="#platform">Platform</a><a href="#features">Features</a><a href="#how-it-works">How it works</a><Link href="/billing">Plans</Link></nav><div className="nav-actions"><ThemeToggle /><Link href="/login" className="nav-login">Login</Link><Link href="/login" className="button button-small">Get started <ArrowRightIcon className="h-4 w-4" /></Link></div></div></header>

    <section className="hero" id="platform"><div className="hero-grid" /><div className="hero-glow hero-glow-one" /><div className="hero-glow hero-glow-two" /><div className="container hero-layout"><div className="hero-copy"><Reveal><div className="eyebrow"><span className="eyebrow-line" /> PROXY ACCESS CONTROL</div></Reveal><Reveal delay={0.06}><h1>Keep proxy access<br /><em>under control.</em></h1></Reveal><Reveal delay={0.12}><p className="hero-lede">V-Guard brings account access, proxy credentials, credits, usage and checkout into one focused workspace.</p></Reveal><Reveal delay={0.18}><div className="hero-actions"><Link href="/login" className="button">Create your account <ArrowRightIcon className="h-5 w-5" /></Link><a href="#features" className="text-link">Explore the platform <ChevronDownIcon className="h-4 w-4" /></a></div></Reveal><Reveal delay={0.24}><div className="hero-note"><CheckIcon className="h-4 w-4" /> Built around the functionality available in V-Guard today</div></Reveal></div><Reveal delay={0.2} className="hero-visual"><DashboardPreview /></Reveal></div><div className="container hero-foot"><span>VICKINS TECHNOLOGIES PRODUCT</span><span className="hero-foot-rule" /><span>ACCESS · CREDITS · USAGE</span></div></section>
